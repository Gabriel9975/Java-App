...
public class GestionUtilisateurs {
    private final List<Utilisateur.java> listUser;
    private final Connexion link;
    ...
    public GestionUtilisateurs(Connexion link, List<java> listUser) {
        this.link = link;
    ...
    public List<java> getListUser() {
        return listUser;
    }

    public Connexion getLink() {
        return link;
    }
}